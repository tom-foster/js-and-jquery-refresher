...
if (response) {
  try {
    ...
    var errorMessage = e.name + ' ' + e.message; //Create error message
    console.log(errorMessage);          //Show developers message
    feed.innerHTML = '<em>Sorry, could not load deals</em>';  //show users message
  } finally {
