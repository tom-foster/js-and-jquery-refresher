...
! function(window, document, undefined) {
    ...
    function injectElementWithStyles(A, e, t, n) {
        var r, o, i, d, a = "modernizr",
            s = createElement("div"),
            l = getBody();
        if (parseInt(t, 10))
            for (; t--;) i = createElement("div"), i.id = n ? n[t] : a + (t + 1), s.appendChild(i);
    ...
    Modernizr.addTest("todataurljpeg", function() {
        ...
        function A(i) {
            ...
            return !d && n > r ? void(e = setTimeout(A, t)) : (o.removeEventListener("playing", A, !1), addTest("videoautoplay", d), void o.parentNode.removeChild(o))
        }
        var e, t = 200,
            n = 5,
            r = 0,
